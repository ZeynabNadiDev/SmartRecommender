    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoriteByUsersId = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
                    FavoriteProductsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUser", x => new { x.FavoriteByUsersId, x.FavoriteProductsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductUser_Users_FavoriteByUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUser_FavoriteProductsId",
                table: "ProductUser",
